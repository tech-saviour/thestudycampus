    ...
    >
      ...
      <div className="relative lg:flex items-center lg:h-96 z-10">
        ...
        <div className="flex justify-center lg:block relative z-10 w-full lg:w-auto">
          <div className="absolute hidden sm:block h-60 w-14 bg-[#FF8800] z-0 top-1/2 -translate-y-1/2 lg:h-96 lg:w-44 lg:ml-32 lg:transform lg:-translate-x-1/2" />
        ...
        <motion.div
          className="relative z-10 py-8 lg:px-2 text-black text-center lg:text-left"
